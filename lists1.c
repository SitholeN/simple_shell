...
/**
 * list_to_strings - it will return an array of strings of the list -> str
...
/**
 * print_list - it prints all the elements of a list_t linked list
 * @h: the pointer to first node
 *
 * Return: size of list
 */
...
/**
 * get_node_index - to get the index of nodes
